...
export function createBaseWorkflowState(overrides: Partial<WorkflowState> = {}): WorkflowState {
  return {
    ...
    setActiveWorkflowDocument: () => undefined,
    closeWorkflowDocument: createNoopAsync(true),
    createWorkflowDocument: () => undefined,

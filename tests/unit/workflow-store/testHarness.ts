...
export function createBaseWorkflowState(overrides: Partial<WorkflowState> = {}): WorkflowState {
  return {
    ...
    saveWorkflowDetailed: createNoopAsync({ success: false, code: 'WORKFLOW_SAVE_FAILED', message: 'Save failed' }),
    duplicateCurrentWorkflow: createNoopAsync(false),
    duplicateCurrentWorkflowDetailed: createNoopAsync({
      success: false,
      code: 'WORKFLOW_DUPLICATE_FAILED',
      message: 'Duplicate failed',
    }),
    deleteCurrentWorkflow: createNoopAsync(false),
    deleteCurrentWorkflowDetailed: createNoopAsync({
      success: false,
      code: 'WORKFLOW_DELETE_FAILED',
      message: 'Delete failed',
    }),
    loadWorkflowDetailed: createNoopAsync({ success: false, code: 'WORKFLOW_LOAD_FAILED', message: 'Load failed' }),

...
router.post('/access/validate', validateBody(zodValidator(adminAccessSchema)), adminConfigController.validateAccess.bind(adminConfigController));
router.use(requireAdminAccess);
router.get('/settings', adminConfigController.getSettings.bind(adminConfigController));
router.put('/settings', validateBody(zodValidator(adminConfigPatchSchema)), adminConfigController.updateSettings.bind(adminConfigController));
router.post('/search/test', validateBody(zodValidator(adminSearchTestSchema)), adminConfigController.testSearch.bind(adminConfigController));

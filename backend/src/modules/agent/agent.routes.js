...
router.post('/memories/import', validateBody(validateAgentMemoryImportBody), agentController.importMemories.bind(agentController));
...
router.get('/sessions/:sessionId', validateParam('sessionId', validateAgentSessionId, decodeURIComponent), agentController.getSession.bind(agentController));
router.post('/sessions/:sessionId/cancel', validateParam('sessionId', validateAgentSessionId, decodeURIComponent), agentController.cancelSession.bind(agentController));

...
function validateId(value: DynamicValue, fieldName: string): string {
...
export function validateAgentChatBody(payload: DynamicValue) {
...
export function validateAgentMemoryImportBody(payload: DynamicValue) {
  const body = ensureObject(payload, 'request body must be an object');
  return {
...
export function validateAgentSessionId(value: DynamicValue): string {
  return validateId(value, 'sessionId');
}

export function validateAgentRecordId(value: DynamicValue): string {

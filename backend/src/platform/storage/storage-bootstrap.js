...
function getDefaultBootstrapConfig() {
  return {
...
function sanitizeBootstrapConfig(input) {
  return {
    version: BOOTSTRAP_CONFIG_VERSION,
...
function writeStoredStorageRootOverride(rootPath) {
...
function getEffectiveStorageRootInfo() {

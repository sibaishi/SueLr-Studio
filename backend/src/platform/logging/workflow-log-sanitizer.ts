...
interface InlineDataArtifactInput {
  keyPath: string;
  value: string;
  mimeType?: string;
  runLogger: WorkflowRunLogger;
...
function createInlineDataArtifact({ keyPath, value, mimeType, runLogger }: InlineDataArtifactInput) {
...
export function sanitizeNodeOutputsForLogs<T>(outputs: T, runLogger?: WorkflowRunLogger | null): T | unknown {

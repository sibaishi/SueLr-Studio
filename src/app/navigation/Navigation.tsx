    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Icon name="bot" size={logoIconSize} style={{ color: '#fff' }} />
          </div>
      ...
      <div
        style={{
          width: '100%',
          padding: collapsed ? '6px 4px' : '10px 8px 8px',
      ...
      >
        <button
          ...
          style={{
            width: themeButtonSize,
            height: themeButtonSize,
            borderRadius: themeButtonRadius,
            border: `1px solid ${T.border}`,
            background: collapsed ? 'transparent' : 'var(--color-bg-tertiary)',
            cursor: 'pointer',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
        ...
        >
          <Icon name={THEME_ICONS[themeMode]} size={themeIconSize} style={{ color: T.text2 }} />
        </button>

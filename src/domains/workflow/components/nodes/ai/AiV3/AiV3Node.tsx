...
function AiV3Node({ id, data, selected, isConnectable }: AiV3NodeProps) {
  const type = 'aiV3';
  ...
  const defaultLabel = def?.label || 'AI 能力 V3';
  ...
  const nodeColor = def?.color || '#0A84FF';

...
interface IterateImageRunV2NodeProps {
  id: string;
...
function IterateImageRunV2Node({ id, data, selected, isConnectable }: IterateImageRunV2NodeProps) {
  const type = 'iterateImageRunV2';
  ...
  const defaultLabel = def?.label || '图像逐项';
...
export default memo(IterateImageRunV2Node);

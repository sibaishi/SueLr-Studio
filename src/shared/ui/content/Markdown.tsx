      ...
      components={{
        ...
        a: ({ href, children }) => (
          <a
            ...
            style={{ color: isUser ? '#fff' : T.blue, textDecoration: 'underline' }}
          >
            {children}
          </a>
        ),
        ...
        blockquote: ({ children }) => (
          <blockquote
            style={{
              borderLeft: `3px solid ${isUser ? 'rgba(255,255,255,0.4)' : T.border}`,
              margin: '6px 0',
              paddingLeft: 10,
              opacity: 0.85,
            }}
        ...
        hr: () => (
          <hr
            style={{
              border: 'none',
              borderTop: `1px solid ${isUser ? 'rgba(255,255,255,0.3)' : T.border}`,
              margin: '8px 0',
            }}
          />
        ),
        table: ({ children }) => (
          <table style={{ borderCollapse: 'collapse', margin: '6px 0', width: '100%' }}>{children}</table>
        ),
        th: ({ children }) => (
          <th
            style={{
              border: `1px solid ${isUser ? 'rgba(255,255,255,0.3)' : T.border}`,
              padding: '4px 8px',
              fontWeight: 600,
            }}
          >
        ...
        td: ({ children }) => (
          <td style={{ border: `1px solid ${isUser ? 'rgba(255,255,255,0.3)' : T.border}`, padding: '4px 8px' }}>
            {children}
          </td>
        ),
      }}
